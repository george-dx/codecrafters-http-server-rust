...
const OK_CREATED_RESPONSE: &[u8] = b"HTTP/1.1 201 Created\r\n\r\n";
            ...
            if start_line_parts[0] == "GET" {
                ...
                if my_file.is_some() {
                    ...
                    match contents {
                        ...
                        Err(..) => {
                            let _ = stream.write_all(NOT_FOUND_RESPONSE).unwrap();
                        }
                    }
                } else {
                    let _ = stream.write_all(NOT_FOUND_RESPONSE).unwrap();
                ...
                if body == "No Body" {
                    ...
                    let _ = stream.write(OK_CREATED_RESPONSE).unwrap();
                }
            }
        }
